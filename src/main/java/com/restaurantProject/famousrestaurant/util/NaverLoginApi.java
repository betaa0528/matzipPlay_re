...
public class NaverLoginApi {
    ...
    private final static String CLIENT_ID = "FqZT48fbncyE6lF33fIA";
    private final static String CLIENT_SECRET = "GOhbu902pM";
    private final static String REDIRECT_URI = "http://restaurant-env.eba-nrkpacdt.ap-northeast-2.elasticbeanstalk.com/callback";
